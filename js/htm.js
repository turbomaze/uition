 ...
 * config */
//HTM config
var numCols = 1024; //how many columns total
var sparsity = 21/1024; //percentage of columns that are active
...
var numPotSyn = 60; //with how many bits can SP cols form synapses?
var minOverlap = 5; //# of active synapses for an SP col to be considered
...
var numNewSyn = 10; //14controls how many synapses are added
var activityThresh = 6; //9# active synapses for a segment to be active
...
function initHTM() {
    ...
    //create the alphanum canvases to test the spatial pooler
...
/* TODO: content editable div to input the alphanum pattern to learn;
    ...
    for (var ai = 0; ai < 0; ai++) {
        SP.process(alphanum.charAt(getRandInt(0, alphanum.length)));
    }
...
/* TODO: improve this "category" encoder */
